...
{/* all main content */}
      ...
      <div className="col-md-7 order-md-2  aboutfirst">
        <h2 >Who We Are:</h2>
      ...
      <div className="col-md-5 order-md-1  aboutfirstimg p-4">
        <img src={about1} alt="" />
      </div>
    </div>
      </div>
      ...
      <div className="row featurette">
      <div className="col-md-7 aboutfirst">
        <h2 >What we do:</h2>
      ...
      <div className="col-md-5 aboutfirstimg p-4">
        <img src={about2} alt="" />
      </div>
    </div>
      </div>
      ...
      <div className="row featurette">
      <div className="col-md-7 order-md-2 aboutthird">
        <b >Communicate:</b>
